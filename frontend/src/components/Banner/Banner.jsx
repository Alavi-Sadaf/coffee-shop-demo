      ...
      <div className="container min-h-[550px] flex justify-center items-center py-12 sm:py-0 overflow-hidden">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className='flex flex-col justify-center gap-6 sm:pt-0'>
            ...
            <p className='text-sm text-gray-500 tracking-wide leading-5'>Rich, flavorful coffee. Crafted from high-quality beans for a smooth and satisfying cup.
            </p>
            <div className='grid grid-cols-2 gap-6'>
              ...
              <div className='border-l-4 border-primary/50 pl-6 space-y-3'>
                ...
                <p className='text-sm text-gray-500 traking-wide leading-5'>
                  {" "}
